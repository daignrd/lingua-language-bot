...
# Optional
NEWS_RSS_URL=...          # a news feed in your target language (enables /news)
WEBAPP_URL=...            # deployed mini-app URL (enables the /tutor classroom)
```
...
src/
  ...
  services/         — external integrations (Supabase, Gemini TTS, Groq, Gemini, live tutor, news, scheduler)
